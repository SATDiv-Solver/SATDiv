...
*SATDiv* is built on top of the SAT solver [CaDiCaL](https://github.com/arminbiere/cadical.git) and utilizes the libraries [nuwls](https://github.com/shaowei-cai-group/NuWLS), [dbg-macro](https://github.com/sharkdp/dbg-macro) and [clipp](https://github.com/muellan/clipp).
